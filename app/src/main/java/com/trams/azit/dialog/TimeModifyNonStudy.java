 ...
 */
public class TimeModifyNonStudy extends ConnActivity {
    ...
    String start_time, end_time, duration, secret, user_id, date, start_time_hour, start_time_minute, end_time_hour, end_time_minute;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_timemodifynonstudy);
        ...
        start_time_hour = start_time.substring(0, 2);
        start_time_minute = start_time.substring(3, 5);

        end_time_hour = end_time.substring(0, 2);
        end_time_minute = end_time.substring(3, 5);
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    ...
                    try {
                        if (response.getString("result").equals("success")) {
                            Toast.makeText(TimeModifyNonStudy.this, "수정되었습니다.", Toast.LENGTH_SHORT).show();
                            finish();
