...
import com.trams.azit.util.LogUtils;
...
//        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        ...
        try {
            LogUtils.i(TAG, "RegistrationIntentService start onHandleIntent");
            ...
            if (token != null) {
                PreferUtils.setToken(getApplicationContext(), token);
            }
...
//        LocalBroadcastManager.getInstance(this).sendBroadcast(registrationComplete);
    ...
    private void sendRegistrationToServer(String token) {
        ...
        try {
            ...
            NetworkHelper.requestJson(this, Url_define.SET_TOKEN + Url_define.KEY, jsonObject, new NetworkHelper.ConnHttpResponseHandler() {
                @Override
