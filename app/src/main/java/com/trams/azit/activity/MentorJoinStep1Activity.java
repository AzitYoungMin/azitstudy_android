...
import com.trams.azit.Regi_mento_;
 ...
 */
public class MentorJoinStep1Activity extends ConnActivity {
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    ...
                    try {
                        if (Boolean.valueOf(response.getString("is_duplicated"))) {
                            ...
                            Intent intent = new Intent(MentorJoinStep1Activity.this, Regi_mento_.class);
                            intent.putExtra(REGISTER_EMAIL, edEmail.getText().toString());
                            intent.putExtra(REGISTER_PASS, edPassword.getText().toString());
