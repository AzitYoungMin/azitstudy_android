...
public class TeacherPageFragment extends Fragment {
    private static final String TAG = TeacherPageFragment.class.getName();
    ...
    List<Integer> korean_method_data, math_method_data, english_method_data, field_method_data;
    List<Integer> korean_textbook_data, math_textbook_data, english_textbook_data, field_textbook_data;
    static ArrayList<List<Integer>> Total_field_method_data, Total_field_textbook_data;
    ...
    private int index;
    private Typeface tf;
    LinearLayout totla_ll, part_ll, method_ll, textbook_ll, content5_ll, content6_ll, detail_ll;
    ...
    public static TeacherPageFragment newInstance(int page) {
    ...
    private void getDataDailyChart() {
        try {
            ...
            jsonObject.put("student_id", PreferUtils.getStudentTeacher(getActivity()));
...
//                        )
            ...
            Total_field_method_data = new ArrayList<List<Integer>>();
            Total_field_textbook_data = new ArrayList<List<Integer>>();
...
//            setThisSubjectGraph();
            setContextsGrapg();
            setMethodGraph(method_graph);
            setTextbookGraph(textbook_graph);
        }
                    ...
                    try {
                        if (response.getString("result").equals("success")) {
                            ...
                            for (int i = 0; i < typeArray.length(); i++) {
                                ...
                                field_tv_method_time1.setText(field_method_data.get(0 + (4 * j)) / 60 + " 분");
                                field_tv_method_time2.setText(field_method_data.get(1 + (4 * j)) / 60 + " 분");
                                field_tv_method_time3.setText(field_method_data.get(2 + (4 * j)) / 60 + " 분");
                                field_tv_method_time4.setText(field_method_data.get(3 + (4 * j)) / 60 + " 분");
                                ...
                                field_tv_textbook_time1.setText(field_textbook_data.get(0 + (7 * j)) / 60 + " 분");
                                field_tv_textbook_time2.setText(field_textbook_data.get(1 + (7 * j)) / 60 + " 분");
                                field_tv_textbook_time3.setText(field_textbook_data.get(2 + (7 * j)) / 60 + " 분");
                                field_tv_textbook_time4.setText(field_textbook_data.get(3 + (7 * j)) / 60 + " 분");
                                field_tv_textbook_time5.setText(field_textbook_data.get(4 + (7 * j)) / 60 + " 분");
                                field_tv_textbook_time6.setText(field_textbook_data.get(5 + (7 * j)) / 60 + " 분");
                                field_tv_textbook_time7.setText(field_textbook_data.get(6 + (7 * j)) / 60 + " 분");
                                ...
                                setMethod_data(Total_field_method_data.get(i));
                                setTextbook_data(Total_field_textbook_data.get(i));

                                setMethodData(4, 100, field_method_graph);
                                setTextbookData(7, 100, field_textbook_graph);
                                j++;

                                setMethodGraph(field_method_graph);
                                setTextbookGraph(field_textbook_graph);
...
//        int[] thisWeek = {260, 490, 678, 553, 436};
    ...
    private void setMethodGraph(PieChart piechart) {
        ...
        setMethodData(korean_method_data.size(), 100, piechart);
    ...
    private void setTextbookGraph(PieChart piechart) {
        piechart.setUsePercentValues(true);
        piechart.setDescription("");
        piechart.setDragDecelerationFrictionCoef(0.95f);
        piechart.setDrawHoleEnabled(false);
        ...
        setTextbookData(korean_textbook_data.size(), 100, piechart);
