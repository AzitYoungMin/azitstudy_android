 ...
 */
public class Ask_Meet_Mentor extends ConnActivity {
            ...
            public void onClick(View v) {
                DialogInterface.OnClickListener confirmListener = new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent i = new Intent(Ask_Meet_Mentor.this, StudentMainActivity.class);
                ...
                new AlertDialog.Builder(Ask_Meet_Mentor.this)
                ...
                try {
                    ...
                    requestJson(url, jsonObject, new ConnActivity.ConnHttpResponseHandler() {
                        ...
                        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                            ...
                            if (posting_id != 0) {
                                Toast.makeText(Ask_Meet_Mentor.this, "수정 완료!", Toast.LENGTH_LONG).show();
                            } else {
                                Toast.makeText(Ask_Meet_Mentor.this, "등록 완료!", Toast.LENGTH_LONG).show();
                            }

                            Intent i = new Intent(Ask_Meet_Mentor.this, My_Act.class);
