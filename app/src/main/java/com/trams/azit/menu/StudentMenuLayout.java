 ...
 */
public class StudentMenuLayout extends LinearLayout {
    ...
    public StudentMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public StudentMenuLayout(Context context) {
        super(context);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        content.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return StudentMenuLayout.this.onContentTouch(v, event);
            }
        });
    ...
    public boolean onContentTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                Log.d("onContentTouch()", "Up lastDiffX "
                        + lastDiffX);
