...
public class Ask extends Activity {
    ...
    ListView ask_list;
    private ListViewAdapter askAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ask_list = (ListView) findViewById(R.id.message_list);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Ask.this, Ask1.class);
                startActivity(i);
            }
        });
    ...
    private void setListView() {
        ...
        askAdapter = new ListViewAdapter(this, mArrayList);
        ask_list.setAdapter(askAdapter);
    }
